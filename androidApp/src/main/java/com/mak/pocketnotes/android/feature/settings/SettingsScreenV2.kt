  ...
  val context = LocalContext.current
    ...
    /*ObserveAsEvents(viewModel.events) { event ->
        when (event) {
            ...
            SettingsEvent.NavigateToLicenses -> { */
...
private fun TextSize.displayName(): String = when (this) {
  TextSize.SMALL -> "Small"
  TextSize.MEDIUM -> "Medium"
  TextSize.LARGE -> "Large"
  TextSize.EXTRA_LARGE -> "Extra Large"
}
private fun TextSize.shortLabel(): String = when (this) {
  TextSize.SMALL -> "S"
  TextSize.MEDIUM -> "M"
  TextSize.LARGE -> "L"
  TextSize.EXTRA_LARGE -> "XL"
}
private fun StreamQuality.displayName(): String = when (this) {
